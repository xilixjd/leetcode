...
class Solution(object):
    ...
    def findPoisonedDurationFaster(self, timeSeries, duration):
        count = 0
        begin = timeSeries[0]
        for t in timeSeries:
            count += t - begin if t < begin + duration else duration
            begin = t
        return count + duration

    def findPoisonedDurationFasterer(self, timeSeries, duration):
        """
        :type timeSeries: List[int]
        :type duration: int
        :rtype: int
...
solu = Solution()
print solu.findPoisonedDuration([1,4,5,6], 2)
print solu.findPoisonedDurationFaster([1,4,5,6], 2)